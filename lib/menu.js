...
function arguments_menu_items_processor (instance, item) {
...
function supportMenus(Meanio){
  ...
  Menus.prototype.add = function(options) {
    ...
    if (arguments.length > 1) {
      Array.prototype.forEach.call(arguments, arguments_menu_items_processor.bind(null, this));
      return this;
    }
